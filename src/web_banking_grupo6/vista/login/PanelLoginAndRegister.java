package web_banking_grupo6.vista.login;

import web_banking_grupo6.vista.componentes.Button;
import web_banking_grupo6.vista.componentes.MyPasswordField;
import web_banking_grupo6.vista.componentes.MyTextField;
import web_banking_grupo6.controlador.GestorLogin;
import web_banking_grupo6.controlador.GestorLogin.ResultadoLogin;
...
public class PanelLoginAndRegister extends javax.swing.JLayeredPane {
    ...
    private Runnable onSwitchToLogin; // Callback para activar animación
    ...
    private void initRegister() {
        ...
        txtNombre.setPrefixIcon(new ImageIcon(getClass().getResource("/resources/icons/user.png")));
        txtNombre.setHint("Nombre Completo");
        ...
        cmd.addActionListener(e -> {
            ...
            ResultadoLogin resultado = loginManager.registrarCliente(nombre, documento, email, password);
            ...
            if (resultado.isExitoso()) {
                ...
                // Activar la animación para cambiar a login
        ...
        cmd.addActionListener(e -> {
            ...
            if (resultado.isExitoso()) {
                ...
                java.awt.EventQueue.invokeLater(() -> {
                    web_banking_grupo6.vista.principal.main.Main mainWindow = 
                        new web_banking_grupo6.vista.principal.main.Main();
