...
import web_banking_grupo6.vista.componentes.ButtonOutLine;
...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        add(title);
        description = new JLabel("Para mantenerte conectado con nosotros por favor");
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                description.setText("Para mantenerte conectado con nosotros por favor");
